<template>
  <div class="min-h-screen bg-white text-gray-800 flex flex-col">
    <!-- Navbar -->
    <header class="sticky top-0 z-50 bg-cyan-900 text-white shadow-md">
      <nav class="px-6 py-4 flex items-center justify-between w-full">
        ...
        <RouterLink to="/" class="text-2xl font-bold tracking-tight text-white flex-grow hover:text-cyan-200 transition-colors inline-flex items-center gap-2">
        ...
        <!-- Desktop nav -->
        <div class="hidden md:flex gap-6 text-base font-medium text-white md:items-center">
...
const navLinkClass = (path) => {
  return route.path === path
    ? 'text-white bg-white/10 rounded-full px-3 py-1'
    : 'hover:text-cyan-300 transition-colors px-3 py-1'
}
