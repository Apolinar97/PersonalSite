...
<template>
  <section class="relative mx-auto max-w-6xl px-6 py-16">
    <div class="pointer-events-none absolute inset-x-0 top-0 -z-10 h-40 bg-gradient-to-b from-[#3A6FF7]/10 to-transparent"></div>

    <header class="max-w-prose">
      <p class="text-xs uppercase tracking-[0.3em] text-[#3A6FF7] font-semibold">Contact</p>
      <h1 class="mt-2 text-4xl md:text-5xl font-extrabold tracking-tight text-[#1F1F1F] leading-tight">
        Let’s get in touch
      </h1>
      <p class="mt-2 text-base md:text-lg text-[#A0A4A8]">
    ...
    <div class="mt-8 grid gap-4 sm:gap-5 sm:grid-cols-2 lg:grid-cols-3">
      <!-- Email card -->
      <div class="group rounded-2xl border border-[#A0A4A8]/30 bg-white p-5 shadow-sm transition hover:shadow-md">
        <div class="flex items-start justify-between gap-4">
          <div class="min-w-0">
            <div class="flex items-center gap-2">
              <span class="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-[#3A6FF7]/10 text-[#3A6FF7] ring-1 ring-[#3A6FF7]/20">
                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                  <path d="M4 6h16a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2Z"/><path d="m22 8-10 6L2 8"/>
                </svg>
              </span>
              <p class="text-sm text-[#A0A4A8]">Email</p>
            </div>
            <a :href="mailto" class="mt-1 block font-medium text-[#1F1F1F] break-all hover:underline">
              {{ email }}
            </a>
          </div>
          <button
        ...
        <p class="mt-2 text-xs text-[#A0A4A8] h-4" aria-live="polite">
          <span
      ...
      <a :href="linkedin" target="_blank" rel="noopener noreferrer"
         class="group rounded-2xl border border-[#A0A4A8]/30 bg-white p-5 shadow-sm transition hover:shadow-md
                focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3A6FF7]">
        <div class="flex items-center justify-between gap-4">
          <div class="min-w-0">
            <div class="flex items-center gap-2">
              ...
              <p class="text-sm text-[#A0A4A8]">LinkedIn</p>
            </div>
            <p class="mt-1 font-medium text-[#1F1F1F] truncate">/in/apolinar-camacho-06560b1a1/</p>
          </div>
        ...
        <div class="flex items-center justify-between gap-4">
          <div class="min-w-0">
            <div class="flex items-center gap-2">
              ...
              <p class="text-sm text-[#A0A4A8]">GitHub</p>
            </div>
            <p class="mt-1 font-medium text-[#1F1F1F] truncate">/apolinar97</p>
          </div>
          <svg class="h-5 w-5 transition-transform group-hover:translate-x-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg>
        </div>
      </a>
