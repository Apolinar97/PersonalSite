...
<template>
  <section class="relative mx-auto max-w-6xl px-6 py-16">
    ...
    <header class="max-w-prose">
      ...
      <h1 class="mt-2 text-4xl md:text-5xl font-extrabold tracking-tight text-primary leading-tight">
        Let’s get in touch
      </h1>
      <p class="mt-2 text-base md:text-lg text-secondary">
    ...
    <div class="mt-8 grid gap-4 sm:gap-5 sm:grid-cols-2 lg:grid-cols-3">
      <!-- Email card -->
      <div class="group rounded-2xl border border-secondary/30 bg-white p-5 shadow-sm transition hover:shadow-md">
        <div class="flex items-start justify-between gap-4">
          <div class="min-w-0">
            <div class="flex items-center gap-2">
              <span class="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-accent/10 text-accent ring-1 ring-accent/20">
            ...
            <a :href="mailto" class="mt-1 block font-medium text-primary break-all hover:underline">
              {{ email }}
            </a>
          </div>
          <button
        ...
        <p class="mt-2 text-xs text-secondary h-4" aria-live="polite">
          <span
      ...
      <a :href="linkedin" target="_blank" rel="noopener noreferrer"
         class="group rounded-2xl border border-secondary/30 bg-white p-5 shadow-sm transition hover:shadow-md
                focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent">
        <div class="flex items-center justify-between gap-4">
          <div class="min-w-0">
            <div class="flex items-center gap-2">
              ...
              <p class="text-sm text-secondary">LinkedIn</p>
            </div>
            <p class="mt-1 font-medium text-primary truncate">/in/apolinar-camacho-06560b1a1/</p>
          </div>
        ...
        <div class="flex items-center justify-between gap-4">
          <div class="min-w-0">
            <div class="flex items-center gap-2">
              ...
              <p class="text-sm text-secondary">GitHub</p>
            </div>
            <p class="mt-1 font-medium text-primary truncate">/apolinar97</p>
          </div>
          <svg class="h-5 w-5 transition-transform group-hover:translate-x-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg>
        </div>
      </a>
